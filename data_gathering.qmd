...
# save to csv
write.csv(funk, "genre_data/funk.csv", row.names = FALSE)
```
...
# save data to csv in correct folder
write.csv(britney_bitch, 'track_data/britney_spears.csv', row.names = FALSE)
```
...
# save data to csv in correct folder
write.csv(bob_dylan, 'track_data/bob_dylan.csv', row.names = FALSE)
write.csv(elvis, 'track_data/elvis.csv', row.names = FALSE)
write.csv(chuck_berry, 'track_data/chuck_berry.csv', row.names = FALSE)
write.csv(beach_boys, 'track_data/beach_boys.csv', row.names = FALSE)
write.csv(madonna, 'track_data/madonna.csv', row.names = FALSE)
```
